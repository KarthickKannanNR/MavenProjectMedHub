...
public class OrderModel {
	...
	public OrderModel(LocalDate orderDate, double price, String orderStatus, String orderType) {
		super();
		this.orderDate = orderDate;
		this.price = price;
		this.orderStatus = orderStatus;
	...
	public OrderModel(LocalDate orderDate, double price, String orderStatus) {
		super();
		this.orderDate = orderDate;
		this.price = price;
		this.orderStatus = orderStatus;
