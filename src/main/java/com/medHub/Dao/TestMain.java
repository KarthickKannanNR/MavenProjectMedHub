...
//																			Show all products
								case 1:
									...
									do {
										System.out.println(
												"   1.Add products to cart   2.Buy Products  3.View cart   4.My Orders   5.Cancel Order");
...
//												(buyProducts.getPoints()*buyProductQuantity)+currentUser.getPoints();
...
//															reducing amt from user wallet
														...
														System.out
																.println("Sorry Currently The Product Is Out Of Stock");
													}
...
//															Forget Password
				case 3:
					...
					int status=userDao1.forgetPassword(userId);
					String NewPassword;
					...
					{
						do{
						randomPin=(int) (Math.random()*7000)+1000;
						System.out.println("enter otp you received");
						System.out.println(randomPin);
						int verifyOtp = Integer.parseInt(sc.nextLine());
						if(randomPin==verifyOtp)
						{
							otpFlag=false;
							do {
							...
							if(NewPassword.equals(confirmPassword))
							{
								...
								int passwordUpdateStatus=userDao1.updatePassword(confirmPassword,userId);
								if(passwordUpdateStatus>0)
								{
